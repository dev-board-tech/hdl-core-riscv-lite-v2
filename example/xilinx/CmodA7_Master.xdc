...
# Clock signal 12 MHz
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { sys_clk_pin }]; #IO_L12P_T1_MRCC_14 Sch=gclk
create_clock -add -name sys_clk_pin -period 83.33 -waveform {0 41.66} [get_ports {sys_clk_pin}];
# create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5.00} [get_ports {sys_clk_pin}];
